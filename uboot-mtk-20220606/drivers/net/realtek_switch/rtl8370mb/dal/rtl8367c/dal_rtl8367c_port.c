 ...
 *      - ENABLE
 */
rtk_api_ret_t dal_rtl8367c_port_phyGreenEthernet_set(rtk_port_t port, rtk_enable_t state)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicGreenEthernet(rtk_switch_port_L2P_get(port), state))!=RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_port_phyGreenEthernet_get(rtk_port_t port, rtk_enable_t *pState)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicGreenEthernet(rtk_switch_port_L2P_get(port), pState))!=RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLE
 */
rtk_api_ret_t dal_rtl8367c_port_phyLinkDownPowerSaving_set(rtk_port_t port, rtk_enable_t state)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicPowerSaving(rtk_switch_port_L2P_get(port), state))!=RT_ERR_OK)
        return retVal;        
 ...
 */
rtk_api_ret_t dal_rtl8367c_port_phyLinkDownPowerSaving_get(rtk_port_t port, rtk_enable_t *pState)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicPowerSaving(rtk_switch_port_L2P_get(port), pState))!=RT_ERR_OK)
        return retVal; 
