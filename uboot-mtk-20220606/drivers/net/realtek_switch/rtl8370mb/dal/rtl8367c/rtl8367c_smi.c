...
extern int rtl8370mb_mdc_mdio_write(unsigned int reg, unsigned int data);
extern int rtl8370mb_mdc_mdio_read(unsigned int reg, unsigned int *data);
#define MDC_MDIO_WRITE(preamableLength, phyID, regID, data) rtl8370mb_mdc_mdio_write(regID, data)
#define MDC_MDIO_READ(preamableLength, phyID, regID, pData) rtl8370mb_mdc_mdio_read(regID, pData)
