 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_gpio_input_get(rtk_uint32 pin, rtk_uint32 *pInput)
{
 ...
 */
rtk_api_ret_t dal_rtl8367c_gpio_output_set(rtk_uint32 pin, rtk_uint32 output)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_gpio_output_get(rtk_uint32 pin, rtk_uint32 *pOutput)
{
    rtk_api_ret_t retVal;
 ...
 *      The API can set GPIO pin output 1 or 0.
 */
rtk_api_ret_t dal_rtl8367c_gpio_state_set(rtk_uint32 pin, rtk_enable_t state)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_gpio_state_get(rtk_uint32 pin, rtk_enable_t *pState)
{
    rtk_api_ret_t retVal;
    rtk_uint32 gpioState;
 ...
 */
rtk_api_ret_t dal_rtl8367c_gpio_mode_set(rtk_uint32 pin, rtk_gpio_mode_t mode)
{
    rtk_api_ret_t retVal;
    rtk_uint32 gpioMode;
 ...
 */
rtk_api_ret_t dal_rtl8367c_gpio_mode_get(rtk_uint32 pin, rtk_gpio_mode_t *pMode)
{
    rtk_api_ret_t retVal;
    rtk_uint32 gpioMode;
 ...
 */
rtk_api_ret_t dal_rtl8367c_gpio_aclEnClear_set(rtk_uint32 pin)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_gpio_aclEnClear_get(rtk_uint32 pin, rtk_enable_t *pAclEn)
{
    rtk_api_ret_t retVal;
    rtk_uint32 data;
